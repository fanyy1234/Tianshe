...
import static com.sunday.member.alipay.SignUtils.sign;
    ...
    private static class SignInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            HttpUrl modifiedUrl = originalRequest.url().newBuilder()
                    ...
                    .addQueryParameter("version", DeviceUtils.getVersion(BaseApplication.getInstance().getApplicationContext()))
