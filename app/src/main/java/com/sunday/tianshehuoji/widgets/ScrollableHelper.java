...
public class ScrollableHelper {
    ...
    private View getScrollableView() {
        ...
        tabHeight = PixUtils.dip2px(mCurrentScrollableCainer.getScrollableView().getContext(),48);
    ...
    private static boolean isRecyclerViewTop(RecyclerView recyclerView) {
        if (recyclerView != null) {
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                if (childAt == null || (firstVisibleItemPosition == 0 && childAt != null && childAt.getTop() == tabHeight)) {
                    return true;
                }
            }
        }
