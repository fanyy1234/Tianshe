...
import com.sunday.tianshehuoji.ui.login.ResetMobileFirstStepActivity;
import com.sunday.tianshehuoji.ui.login.ResetPwdActivity;
...
public class ActivityUserInfo extends BaseActivity {
    ...
    private void initView() {
        ...
        memberLevel.setText(member.getDLevel());
    ...
    void setTvName() {
        /*Intent intent = new Intent(mContext, ResetNickNameActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case REQUEST_CHOOSE_IMAGE:
                ...
                break;
            case REQUEST_NAME:
                String nameStr = data.getStringExtra("nickName");
                tvName.setText(nameStr);
                //updateInfo(null,nameStr);
                break;
        }
    }
