...
public class RegisterActivity extends BaseActivity {
    ...
    void sendCode(){
        ...
        showLoadingDialog(0);
        Call<ResultDO> call = AppClient.getAppAdapter().sendMobileCode(1,mobileStr);
    ...
    void submit(){
        ...
        showLoadingDialog(0);
        Call<ResultDO> call = AppClient.getAppAdapter().memberRegister(mobileStr,newPwd,code);
        call.enqueue(new Callback<ResultDO>() {
            @Override
            public void onResponse(Call<ResultDO> call, Response<ResultDO> response) {
                dissMissDialog();
