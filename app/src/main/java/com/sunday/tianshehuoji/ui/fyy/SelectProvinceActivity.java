...
import com.sunday.tianshehuoji.adapter.CommonAdapter;
import com.sunday.tianshehuoji.adapter.ViewHolder;
...
public class SelectProvinceActivity extends BaseActivity {
    ...
    private void getProvinceList() {
        showLoadingDialog(0);
        Call<ResultDO<List<City>>> call = AppClient.getAppAdapter().getProvinces();
    ...
    private void getCityList() {
        showLoadingDialog(0);
        Call<ResultDO<List<City>>> call = AppClient.getAppAdapter().getCitys(selctItem.getId());
        call.enqueue(new Callback<ResultDO<List<City>>>() {
            @Override
            public void onResponse(Call<ResultDO<List<City>>> call, Response<ResultDO<List<City>>> response) {
                dissMissDialog();
    ...
    private void getDistrictList() {
        showLoadingDialog(0);
        Call<ResultDO<List<City>>> call = AppClient.getAppAdapter().getDistricts(selctItem.getId());
        call.enqueue(new Callback<ResultDO<List<City>>>() {
            @Override
            public void onResponse(Call<ResultDO<List<City>>> call, Response<ResultDO<List<City>>> response) {
                dissMissDialog();
