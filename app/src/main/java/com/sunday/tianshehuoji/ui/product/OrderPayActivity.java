...
public class OrderPayActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        moneyTextView.setText(getIntent().getStringExtra("realMoney"));
    ...
    private void recharge(){
        showLoadingDialog(0);
        Call<ResultDO> call = AppClient.getAppAdapter().payOrder(orderId,payType);
