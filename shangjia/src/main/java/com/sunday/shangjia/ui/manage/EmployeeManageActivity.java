...
public class EmployeeManageActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new EmployeeListAdapter(mContext,dataSet);
    ...
    private void getData(){
        showLoadingDialog(0);
        Call<ResultDO<List<Staff>>> call = AppClient.getAppAdapter().getStaffList(memberId,pageNo,Constants.PAGE_SIZE);
    ...
    void add(){
        intent=new Intent(mContext,AddEmployeeActivity.class);
