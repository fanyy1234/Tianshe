...
import com.sunday.shangjia.entity.SellerShopProductListBean;
...
public class OrderDetailProductAdapter extends BaseAdapter {
    ...
    private List<SellerShopProductListBean> dataSet=new ArrayList<>();

    public OrderDetailProductAdapter(Context context, List<SellerShopProductListBean> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        SellerShopProductListBean item=dataSet.get(position);
