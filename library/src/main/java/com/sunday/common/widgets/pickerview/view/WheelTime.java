package com.sunday.common.widgets.pickerview.view;
...
import com.sunday.common.widgets.pickerview.adapter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    private static int START_YEAR = 2016, END_YEAR = 2050;
    ...
    public static void setEND_MONTH(int eND_YEAR) {
        END_MONTH = END_MONTH;
    }
