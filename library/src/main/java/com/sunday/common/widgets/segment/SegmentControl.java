package com.sunday.common.widgets.segment;
...
public class SegmentControl extends View {
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle){
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.SegmentControl_textSize, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 14, context.getResources().getDisplayMetrics()));
