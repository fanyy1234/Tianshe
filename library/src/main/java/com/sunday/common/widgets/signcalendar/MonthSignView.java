...
public class MonthSignView extends LinearLayout {
    ...
    private void generateChildViews() {
        ...
        final int monthDays = DateUtil.getDateNum(year, month);
        ...
        for(int i=0; i<showRows; i++) {
            ...
            for(int j=0; j<7; j++) {
                ...
                if(showFlag >= weekday && showFlag < showDays) {
                    ...
                    final Date currentDay = new Date(year - 1900, month, currentDayIndex);
                    ...
                    currentMonthDayView.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (listener!=null){
                                listener.onItemSelect(currentDay);
                            }
                        }
                    });
                }else {
    ...
    public interface  OnItemSelectListener{
        public void onItemSelect(Date mMonthSignData);
    }
}
