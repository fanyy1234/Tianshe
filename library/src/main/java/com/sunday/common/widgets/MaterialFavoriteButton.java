...
public class MaterialFavoriteButton extends ImageView {
  ...
  private static final int FAVORITE_STAR_BLACK = R.drawable.ic_star_black;
  private static final int FAVORITE_STAR_BORDER_BLACK = R.drawable.ic_star_border_black;
  private static final int FAVORITE_STAR_WHITE = R.drawable.ic_star_white;
  private static final int FAVORITE_STAR_BORDER_WHITE = R.drawable.ic_star_border_white;
  private static final int FAVORITE_HEART_BLACK = R.drawable.ic_favorite_black;
  private static final int FAVORITE_HEART_BORDER_BLACK = R.drawable.ic_favorite_border_black;
  private static final int FAVORITE_HEART_WHITE = R.drawable.ic_favorite_white;
  private static final int FAVORITE_HEART_BORDER_WHITE = R.drawable.ic_favorite_border_white;
