package com.sunday.common.widgets.refresh;
...
private float mTouchX=0;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(childMove  && Math.abs(dy)<Math.abs(dx)){            //如果横向滑动> 纵向滑动，就拦截事件
                    return false;
    ...
    private boolean  childMove=false;

    public void  isChildMove(boolean bol){
        this.childMove=bol;
    }
