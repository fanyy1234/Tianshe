...
public class ToggleButton extends View {
	...
	public ToggleButton(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		color_theme = a.getColor(R.styleable.ToggleButton_themeColor,
				DEFAULT_COLOR_THEME);
		isOpen = a.getBoolean(R.styleable.ToggleButton_isOpen, false);
		shape = a.getInt(R.styleable.ToggleButton_shape, SHAPE_RECT);
		a.recycle();
	}
