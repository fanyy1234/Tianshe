...
public class ActionSheet extends Fragment implements OnClickListener {
	...
	private static final int BG_VIEW_ID = 0xeeff10;
...
//            ft.commit();
	...
	{
	    // mDismissed为false表示显示，true表示不显示
	    return (!this.mDismissed ? true : false);
	}
	...
	private void createItems() {
		...
		if(!TextUtils.isEmpty(myTitle)){
			...
			textView.setTextColor(mAttrs.titleButtonTextColor);
	...
	private static class Attributes {
		...
		public Attributes(Context context) {
			...
			this.titleButtonTextColor = Color.GRAY;
